...
export default function Login({ navigation }){
    ...
    return (
      <View style={{height:"100%",width:"100%", backgroundColor:"#272727"}}>
        <Button color="white" style={{position:"absolute",bottom:"30%",width:"20%",height:"50%"}} title="Login!" onPress={loginTry}>Login</Button>
        <Button color="white" style={{position:"absolute",bottom:"30%",width:"20%",height:"50%"}} title="Login!" onPress={loginTry}>Register instead!</Button>
      <View style={{height:"100%",width:"100%", backgroundColor:"#272727"}}>
